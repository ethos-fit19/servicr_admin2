      ...
      <div>
              ...
              <div class="lower-container">
                <div>
                  <Form>
                    ...
                    <label for="username">Service Provider Rating</label>
                    <h2 class="status">{`${starrating}/5`}</h2>
                    ...
                    <h2 class="status">
                      {serviceprovider.isApprovedStatus ? "Approved" : "Reject"}
                    </h2>
        ...
        <div className="reviews">
          ...
          {reviews.map((review) => (
            <Card>
              <Link
                to={`/clientprofile/${review.addedBy._id}`}
                className="post-avatar-name"
              >
                <CardHeader
                  avatar={
                    <LetteredAvatar
                      name={review.addedBy.name}
                      size={50}
                      className="avatar"
                    />
                  }
